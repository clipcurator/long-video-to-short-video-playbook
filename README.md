# Long Video to Short Video Playbook
...
1. [How to Turn Long Videos Into Short Clips](docs/how-to-turn-long-videos-into-short-clips.md)
2. [Video Highlight Checklist](docs/video-highlight-checklist.md)
3. [Short Video Structure Template](templates/short-video-structure-template.md)

If you already know the basics and want a use-case workflow:

- [AI Film Recap Workflow](docs/ai-film-recap-workflow.md)
- [Podcast to Short Clips Guide](docs/podcast-to-short-clips-guide.md)

## Common Workflows Covered

### 1. Long video to short clips
...
## Principles Behind Good Long-to-Short Work
...
1. Decide the clip goal before clipping
2. Find narrative or emotional anchors in the source
3. Build the short around one clear payoff
4. Rewrite the opening for speed and clarity
5. Package the short for the destination platform
...
See [docs/faq.md](docs/faq.md) for common questions such as:
...
If you want to improve a workflow, add a template, or share a better example, see [CONTRIBUTING.md](CONTRIBUTING.md).
